...
public class AboutUsActivity extends AppCompatActivity {
    ...
    public void visitTARUC(View view){
        ...
        Intent intent = new Intent(Intent.ACTION_VIEW); //tell app i wan to view smtg
        intent.setData(Uri.parse("https://www.tarc.edu.my")); //tell app i wan view Url link
        if(intent.resolveActivity(getPackageManager())!= null){ // program manager
